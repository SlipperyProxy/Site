    ...
    mobileMenu.style.transform = "translateX(100%)"
        ...
        <header className="home-content">
          <h1 className="home-text06">
            <span className="home-text07">SHIBER </span>
            <br></br>
            <span>The only QoL you want</span>
            <br></br>
          </h1>
          <p className="home-text11">
            <span>
              Shiber, The only QoL mod for Hypixel skyblock with features people
              asked for
            </span>
            <br></br>
            <span>Available in 1.8.9</span>
            <br></br>
          </p>
          <div className="home-container3"></div>
        </header>
        <a
          href="https://github.com/SlipperyProxy/Shiber/releases"
          target="_blank"
          rel="noreferrer noopener"
